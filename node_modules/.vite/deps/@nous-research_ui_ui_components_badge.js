...
// node_modules/@nous-research/ui/dist/ui/components/badge.js
var import_jsx_runtime21 = __toESM(require_jsx_runtime());

// node_modules/@nous-research/ui/dist/ui/components/blend-mode.js
...
var _getProperty = function _getProperty2(target, property, v4) {
  return (v4 = target[property]) && _isFunction(v4) ? target[property]() : _isUndefined(v4) && target.getAttribute && target.getAttribute(property) || v4;
};
...
var _lazyRender = function _lazyRender2() {
  var l4 = _lazyTweens.length, a4 = _lazyTweens.slice(0), i4, tween;
  _lazyLookup = {};
...
var _setDefaults = function _setDefaults2(obj, defaults2) {
  for (var p4 in defaults2) {
    p4 in obj || (obj[p4] = defaults2[p4]);
  }
  return obj;
};
var _setKeyframeDefaults = function _setKeyframeDefaults2(excludeDuration) {
  return function(obj, defaults2) {
    for (var p4 in defaults2) {
      p4 in obj || p4 === "duration" && excludeDuration || p4 === "ease" || (obj[p4] = defaults2[p4]);
    }
  };
};
...
var _mergeDeep = function _mergeDeep2(base, toMerge) {
  for (var p4 in toMerge) {
    p4 !== "__proto__" && p4 !== "constructor" && p4 !== "prototype" && (base[p4] = _isObject(toMerge[p4]) ? _mergeDeep2(base[p4] || (base[p4] = {}), toMerge[p4]) : toMerge[p4]);
  }
  return base;
};
var _copyExcluding = function _copyExcluding2(obj, excluding) {
  var copy = {}, p4;
  for (p4 in obj) {
    p4 in excluding || (copy[p4] = obj[p4]);
  }
  return copy;
};
...
var _parsePosition = function _parsePosition2(animation, position, percentAnimation) {
  var labels = animation.labels, recent = animation._recent || _zeroPosition, clippedDuration = animation.duration() >= _bigNum ? recent.endTime(false) : animation._dur, i4, offset4, isPercent;
  if (_isString(position) && (isNaN(position) || position in labels)) {
    offset4 = position.charAt(0);
    isPercent = position.substr(-1) === "%";
    i4 = position.indexOf("=");
    if (offset4 === "<" || offset4 === ">") {
      i4 >= 0 && (position = position.replace(/=/, ""));
      return (offset4 === "<" ? recent._start : recent.endTime(recent._repeat >= 0)) + (parseFloat(position.substr(1)) || 0) * (isPercent ? (i4 < 0 ? recent : percentAnimation).totalDuration() / 100 : 1);
    }
    if (i4 < 0) {
      position in labels || (labels[position] = clippedDuration);
      return labels[position];
    }
    offset4 = parseFloat(position.charAt(i4 - 1) + position.substr(i4 + 1));
    if (isPercent && percentAnimation) {
      offset4 = offset4 / 100 * (_isArray(percentAnimation) ? percentAnimation[0] : percentAnimation).totalDuration();
    }
    return i4 > 1 ? _parsePosition2(animation, position.substr(0, i4 - 1), percentAnimation) + offset4 : clippedDuration + offset4;
  }
...
var getUnit = function getUnit2(value, v4) {
  return !_isString(value) || !(v4 = _unitExp.exec(value)) ? "" : v4[1];
};
var clamp = function clamp2(min2, max2, value) {
  return _conditionalReturn(value, function(v4) {
    return _clamp(min2, max2, v4);
  });
};
var _slice = [].slice;
...
var selector = function selector2(value) {
  ...
  return function(v4) {
    ...
    return toArray(v4, el.querySelectorAll ? el : el === value ? _warn("Invalid scope") || _doc.createElement("div") : value);
  };
};
...
var distribute = function distribute2(v4) {
  if (_isFunction(v4)) {
    return v4;
  }
  var vars = _isObject(v4) ? v4 : {
    each: v4
  ...
  return function(i4, target, a4) {
    var l4 = (a4 || vars).length, distances = cache[l4], originX, originY, x3, y4, d4, j3, max2, min2, wrapAt;
    if (!distances) {
      wrapAt = vars.grid === "auto" ? 0 : (vars.grid || [1, _bigNum])[1];
      if (!wrapAt) {
        max2 = -_bigNum;
        while (max2 < (max2 = a4[wrapAt++].getBoundingClientRect().left) && wrapAt < l4) {
        }
        wrapAt < l4 && wrapAt--;
      }
      distances = cache[l4] = [];
      ...
      for (j3 = 0; j3 < l4; j3++) {
        ...
        y4 = originY - (j3 / wrapAt | 0);
        distances[j3] = d4 = !axis ? _sqrt(x3 * x3 + y4 * y4) : Math.abs(axis === "y" ? y4 : x3);
        d4 > max2 && (max2 = d4);
        d4 < min2 && (min2 = d4);
      }
...
var _roundModifier = function _roundModifier2(v4) {
  var p4 = Math.pow(10, ((v4 + "").split(".")[1] || "").length);
  return function(raw) {
    var n4 = _roundPrecise(Math.round(parseFloat(raw) / v4) * v4 * p4);
    return (n4 - n4 % 1) / p4 + (_isNumber(raw) ? 0 : getUnit(raw));
  };
};
var snap = function snap2(snapTo, value) {
  ...
  return _conditionalReturn(value, !isArray ? _roundModifier(snapTo) : _isFunction(snapTo) ? function(raw) {
    ...
    var x3 = parseFloat(is2D ? raw.x : raw), y4 = parseFloat(is2D ? raw.y : 0), min2 = _bigNum, closest = 0, i4 = snapTo.length, dx, dy;
    while (i4--) {
      if (is2D) {
        dx = snapTo[i4].x - x3;
        dy = snapTo[i4].y - y4;
...
var pipe = function pipe2() {
  ...
  return function(value) {
    return functions.reduce(function(v4, f4) {
      return f4(v4);
    }, value);
  };
};
...
var _replaceRandom = function _replaceRandom2(s4) {
  return s4.replace(_randomExp, function(match) {
...
var interpolate = function interpolate2(start, end, progress, mutate) {
  var func = isNaN(start + end) ? 0 : function(p5) {
    return (1 - p5) * start + p5 * end;
  };
  if (!func) {
    var isString = _isString(start), master = {}, p4, i4, interpolators, l4, il;
    ...
    if (isString) {
      ...
      func = function func2(p5) {
        p5 *= l4;
        var i5 = Math.min(il, ~~p5);
        return interpolators[i5](p5 - i5);
      };
      progress = end;
    } else if (!mutate) {
    ...
    if (!interpolators) {
      for (p4 in end) {
        _addPropTween.call(master, start, p4, "get", end[p4]);
      }
      func = function func2(p5) {
        return _renderPropTweens(p5, master) || (isString ? start.p : start);
      };
    }
  }
...
var _getLabelInDirection = function _getLabelInDirection2(timeline2, fromTime, backward) {
  var labels = timeline2.labels, min2 = _bigNum, p4, distance, label;
  for (p4 in labels) {
    distance = labels[p4] - fromTime;
...
var _callback = function _callback2(animation, type, executeLazyFirst) {
  var v4 = animation.vars, callback = v4[type], prevContext = _context, context3 = animation._ctx, params, scope, result;
  if (!callback) {
    return;
  }
  params = v4[type + "Params"];
  scope = v4.callbackScope || animation;
...
var _hue = function _hue2(h4, m1, m22) {
  h4 += h4 < 0 ? 1 : h4 > 1 ? -1 : 0;
  return (h4 * 6 < 1 ? m1 + (m22 - m1) * h4 * 6 : h4 < 0.5 ? m22 : h4 * 3 < 2 ? m1 + (m22 - m1) * (2 / 3 - h4) * 6 : m1) * _255 + 0.5 | 0;
};
var splitColor = function splitColor2(v4, toHSL, forceAlpha) {
  var a4 = !v4 ? _colorLookup.black : _isNumber(v4) ? [v4 >> 16, v4 >> 8 & _255, v4 & _255] : 0, r4, g4, b4, h4, s4, l4, max2, min2, d4, wasHSL;
  if (!a4) {
    if (v4.substr(-1) === ",") {
      v4 = v4.substr(0, v4.length - 1);
    }
    if (_colorLookup[v4]) {
      a4 = _colorLookup[v4];
    } else if (v4.charAt(0) === "#") {
      if (v4.length < 6) {
        ...
        g4 = v4.charAt(2);
        b4 = v4.charAt(3);
        v4 = "#" + r4 + r4 + g4 + g4 + b4 + b4 + (v4.length === 5 ? v4.charAt(4) + v4.charAt(4) : "");
      }
      if (v4.length === 9) {
        a4 = parseInt(v4.substr(1, 6), 16);
        return [a4 >> 16, a4 >> 8 & _255, a4 & _255, parseInt(v4.substr(7), 16) / 255];
      }
      v4 = parseInt(v4.substr(1), 16);
      a4 = [v4 >> 16, v4 >> 8 & _255, v4 & _255];
    } else if (v4.substr(0, 3) === "hsl") {
      a4 = wasHSL = v4.match(_strictNumExp);
      if (!toHSL) {
        h4 = +a4[0] % 360 / 360;
        s4 = +a4[1] / 100;
        l4 = +a4[2] / 100;
        g4 = l4 <= 0.5 ? l4 * (s4 + 1) : l4 + s4 - l4 * s4;
        r4 = l4 * 2 - g4;
        a4.length > 3 && (a4[3] *= 1);
        a4[0] = _hue(h4 + 1 / 3, r4, g4);
        a4[1] = _hue(h4, r4, g4);
        a4[2] = _hue(h4 - 1 / 3, r4, g4);
      } else if (~v4.indexOf("=")) {
        a4 = v4.match(_numExp);
      ...
      a4 = v4.match(_strictNumExp) || _colorLookup.transparent;
    }
    a4 = a4.map(Number);
  }
  if (toHSL && !wasHSL) {
    ...
    g4 = a4[1] / _255;
    b4 = a4[2] / _255;
    max2 = Math.max(r4, g4, b4);
    min2 = Math.min(r4, g4, b4);
    l4 = (max2 + min2) / 2;
    if (max2 === min2) {
      h4 = s4 = 0;
    } else {
      d4 = max2 - min2;
      s4 = l4 > 0.5 ? d4 / (2 - max2 - min2) : d4 / (max2 + min2);
      h4 = max2 === r4 ? (g4 - b4) / d4 + (g4 < b4 ? 6 : 0) : max2 === g4 ? (b4 - r4) / d4 + 2 : (r4 - g4) / d4 + 4;
      h4 *= 60;
    }
    a4[0] = ~~(h4 + 0.5);
    a4[1] = ~~(s4 * 100 + 0.5);
...
var _colorOrderData = function _colorOrderData2(v4) {
  var values = [], c4 = [], i4 = -1;
  v4.split(_colorExp).forEach(function(v5) {
    var a4 = v5.match(_numWithUnitExp) || [];
    values.push.apply(values, a4);
    c4.push(i4 += a4.length + 1);
  });
  values.c = c4;
  return values;
};
var _formatColors = function _formatColors2(s4, toHSL, orderMatchData) {
  var result = "", colors = (s4 + result).match(_colorExp), type = toHSL ? "hsla(" : "rgba(", i4 = 0, c4, shell, d4, l4;
  if (!colors) {
    return s4;
  }
  ...
  if (orderMatchData) {
    d4 = _colorOrderData(s4);
    c4 = orderMatchData.c;
    if (c4.join(result) !== d4.c.join(result)) {
      shell = s4.replace(_colorExp, "1").split(_numWithUnitExp);
      l4 = shell.length - 1;
      for (; i4 < l4; i4++) {
        result += shell[i4] + (~c4.indexOf(i4) ? colors.shift() || type + "0,0,0,0)" : (d4.length ? d4 : colors.length ? colors : orderMatchData).shift());
      }
    }
  }
  if (!shell) {
...
var _colorExp = (function() {
  var s4 = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b", p4;
...
var _ticker = (function() {
  var _getTime = Date.now, _lagThreshold = 500, _adjustedLag = 33, _startTime = _getTime(), _lastUpdate = _startTime, _gap = 1e3 / 240, _nextTime = _gap, _listeners2 = [], _id, _req, _raf, _self, _delta, _i, _tick = function _tick2(v4) {
    var elapsed = _getTime() - _lastUpdate, manual = v4 === true, overlap, dispatch, time, frame;
    ...
    if (dispatch) {
      for (_i = 0; _i < _listeners2.length; _i++) {
        _listeners2[_i](time, _delta, frame, v4);
      }
    }
  };
  _self = {
    ...
    add: function add(callback, once, prioritize) {
      var func = once ? function(t4, d4, f4, v4) {
        callback(t4, d4, f4, v4);
        _self.remove(func);
      } : callback;
...
var _parseObjectInString = function _parseObjectInString2(value) {
  var obj = {}, split2 = value.substr(1, value.length - 3).split(":"), key = split2[0], i4 = 1, l4 = split2.length, index2, val, parsedVal;
  for (; i4 < l4; i4++) {
    val = split2[i4];
...
var _insertEase = function _insertEase2(names, easeIn, easeOut, easeInOut) {
  if (easeOut === void 0) {
    easeOut = function easeOut2(p4) {
      return 1 - easeIn(1 - p4);
    };
  }
  if (easeInOut === void 0) {
    easeInOut = function easeInOut2(p4) {
      return p4 < 0.5 ? easeIn(p4 * 2) / 2 : 1 - easeIn((1 - p4) * 2) / 2;
    };
  }
  var ease = {
    easeIn,
  ...
  _forEachName(names, function(name) {
    ...
    for (var p4 in ease) {
      _easeMap[lowercaseName + (p4 === "easeIn" ? ".in" : p4 === "easeOut" ? ".out" : ".inOut")] = _easeMap[name + "." + p4] = ease[p4];
    }
  });
  return ease;
};
var _easeInOutFromOut = function _easeInOutFromOut2(easeOut) {
  return function(p4) {
    return p4 < 0.5 ? (1 - easeOut(1 - p4 * 2)) / 2 : 0.5 + easeOut((p4 - 0.5) * 2) / 2;
  };
};
var _configElastic = function _configElastic2(type, amplitude, period) {
  var p1 = amplitude >= 1 ? amplitude : 1, p22 = (period || (type ? 0.3 : 0.45)) / (amplitude < 1 ? amplitude : 1), p32 = p22 / _2PI * (Math.asin(1 / p1) || 0), easeOut = function easeOut2(p4) {
...
var _configBack = function _configBack2(type, overshoot) {
  ...
  var easeOut = function easeOut2(p4) {
...
_forEachName("Linear,Quad,Cubic,Quart,Quint,Strong", function(name, i4) {
  ...
  _insertEase(name + ",Power" + (power - 1), i4 ? function(p4) {
...
(function(n4, c4) {
  var n1 = 1 / c4, n22 = 2 * n1, n32 = 2.5 * n1, easeOut = function easeOut2(p4) {
    return p4 < n1 ? n4 * p4 * p4 : p4 < n22 ? n4 * Math.pow(p4 - 1.5 / c4, 2) + 0.75 : p4 < n32 ? n4 * (p4 -= 2.25 / c4) * p4 + 0.9375 : n4 * Math.pow(p4 - 2.625 / c4, 2) + 0.984375;
  };
...
_easeMap.SteppedEase = _easeMap.steps = _globals.SteppedEase = {
  config: function config(steps, immediateStart) {
    ...
    var p1 = 1 / steps, p22 = steps + (immediateStart ? 0 : 1), p32 = immediateStart ? 1 : 0, max2 = 1 - _tinyNum;
    return function(p4) {
      return ((p22 * _clamp(0, max2, p4) | 0) + p32) * p1;
    };
  }
};
  ...
  _proto.then = function then(onFulfilled) {
    ...
    return new Promise(function(resolve) {
      var f4 = _isFunction(onFulfilled) ? onFulfilled : _passThrough, _resolve = function _resolve2() {
        ...
        self2.then = null;
        prevProm && prevProm();
        _isFunction(f4) && (f4 = f4(self2)) && (f4.then || f4 === self2) && (self2.then = _then);
        resolve(f4);
        self2.then = _then;
      };
...
var Timeline = (function(_Animation) {
  ...
  _proto2.call = function call2(callback, params, position) {
  ...
  _proto2.killTweensOf = function killTweensOf(targets, props3, onlyActive) {
    var tweens = this.getTweensOf(targets, onlyActive), i4 = tweens.length;
    while (i4--) {
      _overwritingTween !== tweens[i4] && tweens[i4].kill(targets, props3);
    }
    return this;
  };
...
var _addComplexStringPropTween = function _addComplexStringPropTween2(target, prop, start, end, setter, stringFilter, funcParam) {
  var pt = new PropTween(this._pt, target, prop, 0, 1, _renderComplexString, null, setter), index2 = 0, matchIndex = 0, result, startNums, color2, endNum, chunk, startNum, hasRandom, a4;
  pt.b = start;
  pt.e = end;
  start += "";
  end += "";
...
var _addPropTween = function _addPropTween2(target, prop, start, end, index2, targets, modifier, stringFilter, funcParam, optional2) {
  ...
  if (!optional2 || parsedStart !== end || _forceAllPropTweens) {
...
var _processVars = function _processVars2(vars, index2, target, targets, tween) {
  ...
  var copy = {}, p4;
  for (p4 in vars) {
    copy[p4] = _parseFuncOrString(vars[p4], tween, index2, target, targets);
  }
  return copy;
};
var _checkPlugin = function _checkPlugin2(property, vars, tween, index2, target, targets) {
  var plugin2, pt, ptLookup, i4;
  if (_plugins[property] && (plugin2 = new _plugins[property]()).init(target, plugin2.rawVars ? vars[property] : _processVars(vars[property], index2, target, targets, tween), tween, index2, targets) !== false) {
    ...
    if (tween !== _quickTween) {
      ...
      i4 = plugin2._props.length;
      while (i4--) {
        ptLookup[plugin2._props[i4]] = pt;
      }
    }
  }
  return plugin2;
  ...
  if (!tl || keyframes2 && !vars.stagger) {
    ...
    for (i4 = 0; i4 < targets.length; i4++) {
      ...
      if (!harness || harnessVars) {
        for (p4 in cleanVars) {
          if (_plugins[p4] && (plugin2 = _checkPlugin(p4, cleanVars, tween, index2, target, fullTargets))) {
            plugin2.priority && (hasPriority = 1);
          } else {
...
var _addAliasesToVars = function _addAliasesToVars2(targets, vars) {
  var harness = targets[0] ? _getCache(targets[0]).harness : 0, propertyAliases = harness && harness.aliases, copy, p4, i4, aliases;
  if (!propertyAliases) {
    return vars;
  }
  copy = _merge({}, vars);
...
var _parseKeyframe = function _parseKeyframe2(prop, obj, allProps, easeEach) {
  var ease = obj.ease || easeEach || "power1.inOut", p4, a4;
  if (_isArray(obj)) {
...
var Tween = (function(_Animation2) {
      ...
      if (stagger || _isFuncOrString(duration) || _isFuncOrString(delay)) {
        ...
        if (_isObject(stagger)) {
          for (p4 in stagger) {
            if (~_staggerTweenProps.indexOf(p4)) {
              ...
              staggerVarsToMerge[p4] = stagger[p4];
            }
          }
        }
        for (i4 = 0; i4 < l4; i4++) {
        ...
        if (_isArray(keyframes2)) {
          ...
          for (p4 in keyframes2) {
            p4 === "ease" || p4 === "easeEach" || _parseKeyframe(p4, keyframes2[p4], copy, keyframes2.easeEach);
          }
          for (p4 in copy) {
            a4 = copy[p4].sort(function(a5, b4) {
              return a5.t - b4.t;
            });
            time = 0;
  ...
  _proto3.kill = function kill(targets, vars) {
    ...
    var parsedTargets = this._targets, killingTargets = targets ? toArray(targets) : parsedTargets, propTweenLookup = this._ptLookup, firstPT = this._pt, overwrittenProps, curLookup, curOverwriteProps, props3, p4, pt, i4;
  ...
  Tween2.killTweensOf = function killTweensOf(targets, props3, onlyActive) {
    return _globalTimeline.killTweensOf(targets, props3, onlyActive);
  };
  return Tween2;
})(Animation);
...
var _onMediaChange = function _onMediaChange2() {
  ...
  if (time - _lastMediaTime > 2) {
    ...
    _media.forEach(function(c4) {
      var queries = c4.queries, conditions = c4.conditions, match, p4, anyMatch, toggled;
      for (p4 in queries) {
...
var Context = (function() {
  ...
  var _proto5 = Context4.prototype;
  _proto5.add = function add(name, func, scope) {
    ...
    self2.last = f4;
    return name === _isFunction ? f4(self2, function(func2) {
      return self2.add(null, func2);
    }) : name ? self2[name] = f4 : f4;
  };
  ...
  _proto5.getTweens = function getTweens() {
    ...
    this.data.forEach(function(e4) {
      return e4 instanceof Context4 ? a4.push.apply(a4, e4.getTweens()) : e4 instanceof Tween && !(e4.parent && e4.parent.data === "nested") && a4.push(e4);
    });
    return a4;
  };
  ...
  _proto5.kill = function kill(revert, matchMedia2) {
    ...
    if (revert) {
      (function() {
        var tweens = _this4.getTweens(), i5 = _this4.data.length, t4;
        while (i5--) {
          t4 = _this4.data[i5];
          if (t4.data === "isFlip") {
            t4.revert();
...
var MatchMedia = (function() {
  ...
  _proto6.add = function add(conditions, func, scope) {
    ...
    var context3 = new Context(0, scope || this.scope), cond = context3.conditions = {}, mq, p4, active;
...
var _gsap = {
  ...
  getProperty: function getProperty(target, property, unit, uncache) {
    ...
    var getter = _getCache(target || {}).get, format3 = unit ? _passThrough : _numericIfPossible;
    unit === "native" && (unit = "");
    return !target ? target : !property ? function(property2, unit2, uncache2) {
      return format3((_plugins[property2] && _plugins[property2].get || getter)(target, property2, unit2, uncache2));
    } : format3((_plugins[property] && _plugins[property].get || getter)(target, property, unit, uncache));
  },
  quickSetter: function quickSetter(target, property, unit) {
    ...
    var Plugin = _plugins[property], cache = _getCache(target), p4 = cache.harness && (cache.harness.aliases || {})[property] || property, setter = Plugin ? function(value) {
      var p5 = new Plugin();
      _quickTween._pt = 0;
      p5.init(target, unit ? value + unit : value, _quickTween, 0, [target]);
      p5.render(1, p5);
  ...
  matchMediaRefresh: function matchMediaRefresh() {
    return _media.forEach(function(c4) {
      var cond = c4.conditions, found, p4;
      for (p4 in cond) {
        if (cond[p4]) {
          cond[p4] = false;
          found = 1;
...
var _addModifiers = function _addModifiers2(tween, modifiers) {
  var targets = tween._targets, p4, i4, pt;
  for (p4 in modifiers) {
    i4 = targets.length;
    while (i4--) {
      pt = tween._ptLookup[i4][p4];
      if (pt && (pt = pt.d)) {
        if (pt._pt) {
          pt = _getPluginPropTween(pt, p4);
        }
        pt && pt.modifier && pt.modifier(modifiers[p4], tween, targets[i4], p4);
      }
    }
  }
};
...
var gsap = _gsap.registerPlugin({
  ...
  init: function init(target, vars, tween, index2, targets) {
    ...
    this.tween = tween;
    for (p4 in vars) {
      v4 = target.getAttribute(p4) || "";
      pt = this.add(target, "setAttribute", (v4 || 0) + "", vars[p4], index2, targets, 0, 0, p4);
      pt.op = p4;
      pt.b = v4;
      this._props.push(p4);
    }
...
var _revertStyle = function _revertStyle2() {
  var props3 = this.props, target = this.target, style = target.style, cache = target._gsap, i4, p4;
  for (i4 = 0; i4 < props3.length; i4 += 3) {
    if (!props3[i4 + 1]) {
      props3[i4 + 2] ? style[props3[i4]] = props3[i4 + 2] : style.removeProperty(props3[i4].substr(0, 2) === "--" ? props3[i4] : props3[i4].replace(_capsExp, "-$1").toLowerCase());
    } else if (props3[i4 + 1] === 2) {
      target[props3[i4]](props3[i4 + 2]);
    } else {
      target[props3[i4]] = props3[i4 + 2];
    }
  }
...
var _convertToUnit = function _convertToUnit2(target, property, value, unit) {
  ...
  if (cache && toPercent && cache.width && horizontal && cache.time === _ticker.time && !cache.uncache) {
    ...
    if (toPercent && (property === "height" || property === "width")) {
      var v4 = target.style[property];
      target.style[property] = amount + unit;
      px = target[measureProperty];
      v4 ? target.style[property] = v4 : _removeProperty(target, property);
    } else {
...
var _tweenComplexCSSString = function _tweenComplexCSSString2(target, prop, start, end) {
  if (!start || start === "none") {
    var p4 = _checkPropPrefix(prop, target, 1), s4 = p4 && _getComputedProperty(target, p4, 1);
    if (s4 && s4 !== start) {
      prop = p4;
      start = s4;
  ...
  var pt = new PropTween(this._pt, target.style, prop, 0, 1, _renderComplexString), index2 = 0, matchIndex = 0, a4, result, startValues, startNum, color2, startValue, endValue, endNum, chunk, endUnit, startUnit, endValues;
  pt.b = start;
  pt.e = end;
  start += "";
  end += "";
...
var _convertKeywordsToPercentages = function _convertKeywordsToPercentages2(value) {
  var split2 = value.split(" "), x3 = split2[0], y4 = split2[1] || "50%";
  if (x3 === "top" || x3 === "bottom" || y4 === "left" || y4 === "right") {
    value = x3;
    x3 = y4;
    y4 = value;
  }
  split2[0] = _keywordToPercent[x3] || x3;
  split2[1] = _keywordToPercent[y4] || y4;
  return split2.join(" ");
};
var _renderClearProps = function _renderClearProps2(ratio, data) {
  if (data.tween && data.tween._time === data.tween._dur) {
    var target = data.t, style = target.style, props3 = data.u, cache = target._gsap, prop, clearTransforms, i4;
    if (props3 === "all" || props3 === true) {
      style.cssText = "";
      clearTransforms = 1;
    } else {
      props3 = props3.split(",");
...
var _applySVGOrigin = function _applySVGOrigin2(target, origin, originIsAbsolute, smooth, matrixArray, pluginToAddPropTweensTo) {
  var cache = target._gsap, matrix = matrixArray || _getMatrix(target, true), xOriginOld = cache.xOrigin || 0, yOriginOld = cache.yOrigin || 0, xOffsetOld = cache.xOffset || 0, yOffsetOld = cache.yOffset || 0, a4 = matrix[0], b4 = matrix[1], c4 = matrix[2], d4 = matrix[3], tx = matrix[4], ty = matrix[5], originSplit = origin.split(" "), xOrigin = parseFloat(originSplit[0]) || 0, yOrigin = parseFloat(originSplit[1]) || 0, bounds, determinant, x3, y4;
  if (!originIsAbsolute) {
    bounds = _getBBox(target);
    xOrigin = bounds.x + (~originSplit[0].indexOf("%") ? xOrigin / 100 * bounds.width : xOrigin);
    yOrigin = bounds.y + (~(originSplit[1] || originSplit[0]).indexOf("%") ? yOrigin / 100 * bounds.height : yOrigin);
  } else if (matrix !== _identity2DMatrix && (determinant = a4 * d4 - b4 * c4)) {
    x3 = xOrigin * (d4 / determinant) + yOrigin * (-c4 / determinant) + (c4 * ty - d4 * tx) / determinant;
    y4 = xOrigin * (-b4 / determinant) + yOrigin * (a4 / determinant) - (a4 * ty - b4 * tx) / determinant;
    xOrigin = x3;
    yOrigin = y4;
  }
  if (smooth || smooth !== false && cache.smooth) {
    ...
    cache.xOffset = xOffsetOld + (tx * a4 + ty * c4) - tx;
    cache.yOffset = yOffsetOld + (tx * b4 + ty * d4) - ty;
  } else {
...
var _parseTransform = function _parseTransform2(target, uncache) {
  ...
  var style = target.style, invertedScaleX = cache.scaleX < 0, px = "px", deg = "deg", cs = getComputedStyle(target), origin = _getComputedProperty(target, _transformOriginProp) || "0", x3, y4, z2, scaleX, scaleY, rotation, rotationX, rotationY, skewX, skewY, perspective, xOrigin, yOrigin, matrix, angle, cos, sin, a4, b4, c4, d4, a12, a22, t1, t22, t32, a13, a23, a33, a42, a43, a32;
  x3 = y4 = z2 = rotation = rotationX = rotationY = skewX = skewY = perspective = 0;
  scaleX = scaleY = 1;
  ...
  if (matrix !== _identity2DMatrix) {
    ...
    y4 = a22 = matrix[5];
    if (matrix.length === 6) {
      scaleX = Math.sqrt(a4 * a4 + b4 * b4);
      scaleY = Math.sqrt(d4 * d4 + c4 * c4);
      rotation = a4 || b4 ? _atan2(b4, a4) * _RAD2DEG : 0;
      skewX = c4 || d4 ? _atan2(c4, d4) * _RAD2DEG + rotation : 0;
      skewX && (scaleY *= Math.abs(Math.cos(skewX * _DEG2RAD)));
      if (cache.svg) {
        x3 -= xOrigin - (xOrigin * a4 + yOrigin * c4);
        y4 -= yOrigin - (xOrigin * b4 + yOrigin * d4);
      }
    } else {
      a32 = matrix[6];
      a42 = matrix[7];
      ...
      scaleX = _round(Math.sqrt(a4 * a4 + b4 * b4 + c4 * c4));
  ...
  cache.y = y4 - ((cache.yPercent = y4 && (!uncache && cache.yPercent || (Math.round(target.offsetHeight / 2) === Math.round(-y4) ? -50 : 0))) ? target.offsetHeight * cache.yPercent / 100 : 0) + px;
  cache.z = z2 + px;
...
var _renderCSSTransforms = function _renderCSSTransforms2(ratio, cache) {
  var _ref = cache || this, xPercent = _ref.xPercent, yPercent = _ref.yPercent, x3 = _ref.x, y4 = _ref.y, z2 = _ref.z, rotation = _ref.rotation, rotationY = _ref.rotationY, rotationX = _ref.rotationX, skewX = _ref.skewX, skewY = _ref.skewY, scaleX = _ref.scaleX, scaleY = _ref.scaleY, transformPerspective = _ref.transformPerspective, force3D = _ref.force3D, target = _ref.target, zOrigin = _ref.zOrigin, transforms = "", use3D = force3D === "auto" && ratio && ratio !== 1 || force3D === true;
  if (zOrigin && (rotationX !== _zeroDeg || rotationY !== _zeroDeg)) {
    var angle = parseFloat(rotationY) * _DEG2RAD, a13 = Math.sin(angle), a33 = Math.cos(angle), cos;
    angle = parseFloat(rotationX) * _DEG2RAD;
    cos = Math.cos(angle);
    x3 = _addPxTranslate(target, x3, a13 * cos * -zOrigin);
    y4 = _addPxTranslate(target, y4, -Math.sin(angle) * -zOrigin);
  ...
  if (use3D || x3 !== _zeroPx || y4 !== _zeroPx || z2 !== _zeroPx) {
    transforms += z2 !== _zeroPx || use3D ? "translate3d(" + x3 + ", " + y4 + ", " + z2 + ") " : "translate(" + x3 + ", " + y4 + _endParenthesis;
  }
...
var _renderSVGTransforms = function _renderSVGTransforms2(ratio, cache) {
  var _ref2 = cache || this, xPercent = _ref2.xPercent, yPercent = _ref2.yPercent, x3 = _ref2.x, y4 = _ref2.y, rotation = _ref2.rotation, skewX = _ref2.skewX, skewY = _ref2.skewY, scaleX = _ref2.scaleX, scaleY = _ref2.scaleY, target = _ref2.target, xOrigin = _ref2.xOrigin, yOrigin = _ref2.yOrigin, xOffset = _ref2.xOffset, yOffset = _ref2.yOffset, forceCSS = _ref2.forceCSS, tx = parseFloat(x3), ty = parseFloat(y4), a11, a21, a12, a22, temp;
  ...
  if (tx && !~(x3 + "").indexOf("px") || ty && !~(y4 + "").indexOf("px")) {
    tx = _convertToUnit(target, "x", x3, "px");
    ty = _convertToUnit(target, "y", y4, "px");
  }
...
var _addRawTransformPTs = function _addRawTransformPTs2(plugin2, transforms, target) {
  ...
  for (p4 in _transformProps) {
    ...
    if (startValue !== endValue && exclude.indexOf(p4) < 0) {
      ...
      endNum = parseFloat(endValue);
      plugin2._pt = new PropTween(plugin2._pt, endCache, p4, startNum, endNum - startNum, _renderCSSProp);
      plugin2._pt.u = endUnit || 0;
      plugin2._props.push(p4);
    }
  }
  _assign(endCache, startCache);
};
_forEachName("padding,margin,Width,Radius", function(name, index2) {
  var t4 = "Top", r4 = "Right", b4 = "Bottom", l4 = "Left", props3 = (index2 < 3 ? [t4, r4, b4, l4] : [t4 + l4, t4 + r4, b4 + r4, b4 + l4]).map(function(side) {
  ...
  _specialProps[index2 > 1 ? "border" + name : name] = function(plugin2, target, property, endValue, tween) {
    ...
    a4 = (endValue + "").split(" ");
    vars = {};
    props3.forEach(function(prop, i4) {
...
var CSSPlugin = {
  ...
  init: function init3(target, vars, tween, index2, targets) {
    var props3 = this._props, style = target.style, startAt = tween.vars.startAt, startValue, endValue, endNum, startNum, type, specialProp, p4, startUnit, endUnit, relative, isTransformRelated, transformPropTween, cache, smooth, hasPriority, inlineProps, finalTransformValue;
    _pluginInitted || _initCore();
  ...
  getSetter: function getSetter(target, property, plugin2) {
    var p4 = _propertyAliases[property];
    p4 && p4.indexOf(",") < 0 && (property = p4);
...
function createSlot(ownerName) {
  ...
  const Slot22 = React.forwardRef((props3, forwardedRef) => {
...
function createSlotClone(ownerName) {
  const SlotClone = React.forwardRef((props3, forwardedRef) => {
    let { children, ...slotProps } = props3;
    if (isLazyComponent(children) && typeof use === "function") {
      children = use(children._payload);
    }
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node2 = React2.forwardRef((props3, forwardedRef) => {
...
var Portal = React3.forwardRef((props3, forwardedRef) => {
...
var Context2 = function Context3(chain2, nextRuleModifiers) {
  if (chain2 === void 0) chain2 = [];
  if (nextRuleModifiers === void 0) nextRuleModifiers = [];
  this.chain = chain2;
  this.nextRuleModifiers = nextRuleModifiers;
};
Context2.prototype._applyRule = function _applyRule(ruleFn, name) {
  var this$1 = this;
  return function() {
...
Context2.prototype._applyModifier = function _applyModifier(modifier, name) {
  this.nextRuleModifiers.push(
    new Modifier(name, modifier.simple, modifier.async)
  );
  return this;
};
Context2.prototype._clone = function _clone() {
  return new Context2(this.chain.slice(), this.nextRuleModifiers.slice());
};
Context2.prototype.test = function test(value) {
  return this.chain.every(function(rule) {
    return rule._test(value);
  });
};
Context2.prototype.testAll = function testAll(value) {
  var err = [];
...
Context2.prototype.check = function check(value) {
  this.chain.forEach(function(rule) {
    try {
      rule._check(value);
    } catch (ex) {
...
Context2.prototype.testAsync = function testAsync(value) {
  var this$1 = this;
  return new Promise(function(resolve, reject) {
...
function v8n() {
  return typeof Proxy !== "undefined" ? proxyContext(new Context2()) : proxylessContext(new Context2());
}
var customRules = {};
...
function proxyContext(context3) {
  return new Proxy(context3, {
    get: function get(obj, prop) {
      if (prop in obj) {
        return obj[prop];
      }
      var newContext = proxyContext(context3._clone());
...
function proxylessContext(context3) {
  ...
  var contextWithAvailableRules = addRuleSet(availableRules, context3);
...
function rubberbandIfOutOfBounds(position, min2, max2, constant = 0.15) {
  if (constant === 0) return clamp3(position, min2, max2);
...
var Engine = class {
  ...
  compute(event) {
    ...
    if (gestureIsActive) {
      ...
      if (event) {
        if (state.first) {
          if ("bounds" in config3) state._bounds = call(config3.bounds, state);
    ...
    const rubberband2 = state._active ? config3.rubberband || [0, 0] : [0, 0];
...
function resolveWith(config3 = {}, resolvers) {
  ...
  for (const [key, resolver] of Object.entries(resolvers)) {
    switch (typeof resolver) {
      case "function":
        if (true) {
          const r4 = resolver.call(result, config3[key], key, config3);
...
function parse(newConfig, gestureKey, _config2 = {}) {
  ...
  if (gestureKey) {
    ...
    _config2[gestureKey] = resolveWith(_objectSpread2({
    ...
    for (const key in rest2) {
      ...
      if (resolver) {
        _config2[key] = resolveWith(_objectSpread2({
          shared: _config2.shared
        }, rest2[key]), resolver);
      } else if (true) {
...
function createSlot2(ownerName) {
  ...
  const Slot22 = React5.forwardRef((props3, forwardedRef) => {
...
function createSlotClone2(ownerName) {
  const SlotClone = React5.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    if (React5.isValidElement(children)) {
      ...
      return React5.cloneElement(children, props22);
    }
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  ...
  const Node2 = React6.forwardRef((props3, forwardedRef) => {
    const { asChild, ...primitiveProps } = props3;
    const Comp = asChild ? Slot7 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var DismissableLayer = React9.forwardRef(
  (props3, forwardedRef) => {
    ...
    const context3 = React9.useContext(DismissableLayerContext);
...
var DismissableLayerBranch = React9.forwardRef((props3, forwardedRef) => {
  ...
  return (0, import_jsx_runtime6.jsx)(Primitive2.div, { ...props3, ref: composedRefs });
});
...
var arrow = (options) => ({
  ...
  async fn(state) {
    ...
    const offset4 = clamp4(min$1, center, max2);
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React12.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
...
function createSlotClone3(ownerName) {
  const SlotClone = React12.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    if (React12.isValidElement(children)) {
      ...
      return React12.cloneElement(children, props22);
    }
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  ...
  const Node2 = React13.forwardRef((props3, forwardedRef) => {
    const { asChild, ...primitiveProps } = props3;
    const Comp = asChild ? Slot7 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Arrow = React14.forwardRef((props3, forwardedRef) => {
  ...
  return (0, import_jsx_runtime9.jsx)(
    Primitive3.svg,
    {
      ...
      children: props3.asChild ? children : (0, import_jsx_runtime9.jsx)("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React15.forwardRef((props3, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime10.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React15.isValidElement(newElement) ? React15.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var PopperContent = React17.forwardRef(
  (props3, forwardedRef) => {
    ...
    const context3 = usePopperContext(CONTENT_NAME, __scopePopper);
...
var PopperArrow = React17.forwardRef(function PopperArrow2(props3, forwardedRef) {
...
var Portal2 = React20.forwardRef((props3, forwardedRef) => {
  const { container: containerProp, ...portalProps } = props3;
  const [mounted, setMounted] = React20.useState(false);
  useLayoutEffect2(() => setMounted(true), []);
  const container = containerProp || mounted && globalThis?.document?.body;
  return container ? import_react_dom3.default.createPortal((0, import_jsx_runtime15.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
  ...
  (props3, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime19.jsx)(
      Primitive5.button,
      {
        ...
        onBlur: composeEventHandlers(props3.onBlur, context3.onClose),
        onClick: composeEventHandlers(props3.onClick, context3.onClose)
      }
    ) });
  }
);
...
var TooltipPortal = (props3) => {
  ...
  const context3 = useTooltipContext(PORTAL_NAME3, __scopeTooltip);
  return (0, import_jsx_runtime19.jsx)(PortalProvider, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context3.open, children: (0, import_jsx_runtime19.jsx)(Portal2, { asChild: true, container, children }) }) });
};
...
var TooltipContent = React24.forwardRef(
  (props3, forwardedRef) => {
    ...
    const context3 = useTooltipContext(CONTENT_NAME2, props3.__scopeTooltip);
    return (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context3.open, children: context3.disableHoverableContent ? (0, import_jsx_runtime19.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime19.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React24.forwardRef((props3, forwardedRef) => {
  ...
  return (0, import_jsx_runtime19.jsx)(TooltipContentImpl, { ...props3, ref: composedRefs });
});
...
var TooltipContentImpl = React24.forwardRef(
  (props3, forwardedRef) => {
    ...
    const context3 = useTooltipContext(CONTENT_NAME2, __scopeTooltip);
    const popperScope = usePopperScope(__scopeTooltip);
        ...
        children: (0, import_jsx_runtime19.jsxs)(
          Content,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime19.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime19.jsx)(Root3, { id: context3.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var clamp5 = (x3, min2, max2) => x3 > max2 ? max2 : x3 < min2 ? min2 : x3;
var parseNumber = (v4) => {
...
var normalize$2 = (_ref) => {
  ...
  _value = clamp5(_value, min2, max2);
  ...
  const pad = Math.round(clamp5(Math.log10(1 / padStep), 0, 2));
  return {
...
function useDrag2(handler, config3) {
  const {
    emitOnEditStart,
    emitOnEditEnd
  } = useInputContext();
...
function createStore(createState) {
  ...
  const subscribeWithSelector2 = (listener, selector3 = getState, equalityFn = Object.is) => {
    console.warn("[DEPRECATED] Please use `subscribeWithSelector` middleware");
    let currentSlice = selector3(state);
    function listenerToAdd() {
      const nextSlice = selector3(state);
  ...
  const subscribe = (listener, selector3, equalityFn) => {
    if (selector3 || equalityFn) {
      return subscribeWithSelector2(listener, selector3, equalityFn);
    }
...
function create(createState) {
  ...
  const useStore2 = (selector3 = api.getState, equalityFn = Object.is) => {
    const [, forceUpdate] = (0, import_react9.useReducer)((c4) => c4 + 1, 0);
    const state = api.getState();
    const stateRef = (0, import_react9.useRef)(state);
    const selectorRef = (0, import_react9.useRef)(selector3);
    ...
    if (currentSliceRef.current === void 0) {
      currentSliceRef.current = selector3(state);
    }
    let newStateSlice;
    let hasNewStateSlice = false;
    if (stateRef.current !== state || selectorRef.current !== selector3 || equalityFnRef.current !== equalityFn || erroredRef.current) {
      newStateSlice = selector3(state);
...
var subscribeWithSelector = (fn) => (set, get, api) => {
  ...
  api.subscribe = (selector3, optListener, options) => {
    let listener = selector3;
    if (optListener) {
      const equalityFn = (options == null ? void 0 : options.equalityFn) || Object.is;
      let currentSlice = selector3(api.getState());
      listener = (state) => {
        const nextSlice = selector3(state);
        if (!equalityFn(currentSlice, nextSlice)) {
          const previousSlice = currentSlice;
...
function Joystick({
  ...
  const bind = useDrag2(({
    ...
    const _x = clamp5(mx, -w3, w3);
    const _y = clamp5(my, -h4, h4);
...
var sanitize2 = (value, {
  ...
  return [clamp5(Number(min2), MIN, Math.max(MIN, max2)), clamp5(Number(max2), Math.min(MAX, min2), MAX)];
};
var normalize4 = ({
  value,
  min: min2,
...
// node_modules/@nous-research/ui/dist/hooks/use-smooth-controls.js
var import_react13 = __toESM(require_react(), 1);
var atomRegistry = /* @__PURE__ */ new Map();
var getControlAtom = (label, key) => atomRegistry.get(label)?.get(key);

// node_modules/@nous-research/ui/dist/ui/components/blend-mode.js
var LAYER_KEYS = { bg: "bgColor", fg: "fgColor", mg: "mgColor" };
var parseSpec = (spec) => {
  const [layer, alpha] = spec.split("/");
  return [layer, alpha ? parseFloat(alpha) : void 0];
};
var useControlColor = (key, fallback) => {
  const atom2 = getControlAtom("Lens", key);
  return (atom2 ? useStore(atom2) : void 0) ?? fallback;
};
var useBlend = (against, spec) => {
...
var useBlendMode = (opts = {}) => {
  const { against = "bg", background, color: color2 } = opts;
  return {
    backgroundColor: useBlend(against, background),
    color: useBlend(against, color2)
  };
};
var BlendMode = polyRef(
  ({ against, as, background, children, className, color: color2, style, ...rest2 }, ref) => {
    const colors = useBlendMode({ against, background, color: color2 });
    if (typeof children === "function") {
      return (0, import_jsx_runtime20.jsx)(import_jsx_runtime20.Fragment, { children: children(colors) });
    }
    return (0, import_react15.createElement)(as ?? "div", {
      ...rest2,
      children,
...
// node_modules/@nous-research/ui/dist/ui/components/badge.js
var BASE_CN = "inline-flex items-center font-compressed text-display px-2 py-1 leading-none tracking-[0.2em]";
var TONE_CLASSES = {
...
//# sourceMappingURL=@nous-research_ui_ui_components_badge.js.map
